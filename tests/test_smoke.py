...
from study_cards.cli import main
from study_cards.models import Note, ProjectState, Task
from study_cards.cli import demo_state
from study_cards.storage import load_state, save_state
from study_cards.models import generate_short_id
from study_cards.validation import normalize_tags, require_text, validate_task_status
from study_cards.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
